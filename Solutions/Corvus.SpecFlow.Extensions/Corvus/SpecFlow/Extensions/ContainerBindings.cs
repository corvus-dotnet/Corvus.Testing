...
namespace Corvus.SpecFlow.Extensions
{
    ...
    /// <summary>
    /// Provides Specflow bindings for DI Composition.
    /// </summary>
    [Binding]
    public static class ContainerBindings
    {
        ...
        /// </summary>
        /// <param name="scenarioContext">The SpecFlow context.</param>
        /// <returns>The service provider.</returns>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="featureContext">SpecFlow-supplied feature context.</param>
        /// <param name="scenarioContext">SpecFlow-supplied scenario context.</param>
        ...
        /// </summary>
        /// <param name="scenarioContext">SpecFlow-supplied context.</param>
        /// <remarks>We expect scenarios run in parallel to be executing in separate app domains.</remarks>
