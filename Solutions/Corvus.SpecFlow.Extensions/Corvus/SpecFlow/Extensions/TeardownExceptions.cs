...
namespace Corvus.SpecFlow.Extensions
{
    ...
    /// <remarks>
    /// <para>
    /// SpecFlow has an unfortunate problem with exceptions in 'After' bindings. If one
    ...
    /// relevant SpecFlow context, and then rethrow them later in the various bindings in
    ...
    public static class TeardownExceptions
    {
        ...
        /// </summary>
        /// <param name="scenarioContext">The SpecFlow scenario context.</param>
        /// <param name="action">The method to run.</param>
        ...
        private static void RunAndStoreExceptions(this SpecFlowContext context, Action action, string key)
        {
        ...
        private static async Task RunAndStoreExceptionsAsync(this SpecFlowContext context, Func<Task> action, string key)
        {
            TeardownExceptionsBindings.VerifyBindingAvailable(context);
            try
            {
